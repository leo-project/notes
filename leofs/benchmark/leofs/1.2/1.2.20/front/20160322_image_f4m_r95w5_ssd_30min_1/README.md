...
### Purpose
We check the performance of LeoFS 1.2.20-dev (SSD)
...
* HDD (node[36~39]) : Crucial CT500BX100SSD1 
...
### OPS and Latency:
**AVS 8**
![ops-latency](avs8/summary.png)
**AVS 64**
![ops-latency-avs64](avs64/summary.png)

### Monitoring Results:
**AVS 8**
![monitoring-results](avs8/grafana.png)
**AVS 64**
![monitoring-results-avs64](avs64/grafana.png)
